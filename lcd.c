...
// Dia chi cot:  bat dau tu 0 -> 40 (tuy vao lcd ma so cot duoc hien thi khac nhau)
//*****************************************************************************
...
//-----------------------------------------------------------------------------
void lcd_write_char(char charactor)
{
...
void lcd_goto_row_col(unsigned char row, unsigned char col)
{
	...
	switch(row)
	{
		case 0: address=0x00; break; //line 1: begin 0  (0x00) -> 39  (0x27)
		case 1:	address=0x40; break; //line 2: begin 64 (0x40) -> 103 (0x67)
		case 2:	address=0x14; break; //line 3: begin 64 (0x40) -> 103 (0x67)
		case 3:	address=0x54; break; //line 4: begin 64 (0x40) -> 103 (0x67)
...
void lcd_custom_char(char row, char col, char add_cgram, unsigned char custom_char[])
{
	...
	for(i=0;i<8;i++)lcd_write_char(custom_char[i]);
	
	lcd_goto_row_col(row,col);
	lcd_write_char(add_cgram);
}
...
void lcd_write_cgram(char add_cgram, unsigned char custom_char[])
{
	...
	lcd_goto_row_col(0,0);		//dua con tro ve dau dong hang thu nhat
}
